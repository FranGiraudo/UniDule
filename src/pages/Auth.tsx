...
export function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!email || !password)
      return setFeedback({ text: 'Por favor, completá los datos', isError: true });
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ textAlign: 'left', marginBottom: '1rem' }}>
            <label
              className="f-label"
              style={{ fontSize: '0.85rem', textTransform: 'none', letterSpacing: 'normal' }}
            >
              Correo Electrónico
            </label>
            <input
          ...
          {feedback && (
            <div
              style={{
                color: feedback.isError ? '#ef4444' : '#3b82f6',
                fontSize: '0.9rem',
                marginBottom: '1.5rem',
                textAlign: 'center',
                fontWeight: 600,
                background: feedback.isError ? 'rgba(239,68,68,0.1)' : 'rgba(59,130,246,0.1)',
                padding: '0.75rem',
                borderRadius: '8px',
              }}
            >
