      ...
      {!hasAnySubjects ? (
        ...
        years.map((year) => {
          ...
          const approved = subjects.filter(
            (s) => s.year === year && s.status === 'aprobada',
          ).length;
          ...
          return (
            <div
              key={year}
              className={`career-year-block ${collapsedYears[year] ? 'collapsed' : ''}`}
            >
              <div className="career-year-header" onClick={() => toggleYear(year)}>
                ...
                >
                  ...
                  <div className="career-year-bar-wrap">
                    <div
                      className="career-year-bar-fill"
                      style={{ width: `${pct}%`, background: barColor }}
                    ></div>
                  </div>
                  <span style={{ fontSize: '11px', color: 'var(--text2)', minWidth: '2.5rem' }}>
                    {pct}%
                  </span>
                </div>
                          ...
                          >
                            <div className="career-sub-info">
                              ...
                              <div className="career-sub-meta">
                                ...
                                {canFinal && (
                                  <span className="career-final-badge">Final disponible</span>
                                )}
                              </div>
                            </div>
                            <span
